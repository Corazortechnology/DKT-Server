...
//special requests
router.post("/special-request", authenticateToken, createSpecialRequest);
router.get(
  "/special-request/:donorId",
  authenticateToken,
  getSpecialRequestsByDonor
);
router.get("/special-request", authenticateToken, getMySpecialRequests);
router.get("/all-special-request", authenticateToken, getAllSpecialRequests);
router.patch("/special-request/accept/:id", acceptSpecialRequest);
router.patch("/special-request/reject/:id", rejectSpecialRequest);
router.post(
  "/special-request/agreement/:id",
